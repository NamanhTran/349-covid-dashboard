...
class Covid extends Component {
    //update_url = `https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_daily_reports_us/${String((new Date).getDate()).padStart(2, '0')}-${String((new Date).getMonth() + 1).padStart(2, '0')}-${String((new Date).getDate()).padStart(2, '0')}.csv`;
    state = {
        countries: [],
        filterText: "",
        allCountryTotal: 0,
    ...
    url = `https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_daily_reports_us/${String((new Date()).getMonth() + 1).padStart(2, '0')}-${String((new Date()).getDate() - 1).padStart(2, '0')}-${(new Date()).getFullYear()}.csv`;;
